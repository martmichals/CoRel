...
for subtopic in probability machine_learning data_mining natural_language_processing firstlayer
do
  topic_file=${subtopic}
  ...
  python3 ../generate_final_taxonomy.py --dataset ../${dataset} --topic_file topics_${topic_file}.txt --emb ${emb_file} --out_file subtopics_${output_file}.txt
